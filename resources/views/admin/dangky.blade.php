          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="form-row ">
                    ...
                    <div class="col-md-8">
                     ...
                     <div class="form-row ">
                    <div class="col-md-4">
                               <label class="form-label " for="typeEmailX-2"><h5>Full Name</h5></label>
                    </div>
                    <div class="col-md-8">
                     ...
                     <div class="form-row ">
                    <div class="col-md-4">
                               <label class="form-label " for="typeEmailX-2"><h5>SĐT</h5></label>
                    </div>
                    <div class="col-md-8">
                     ...
                     <div class="form-row ">
                    <div class="col-md-4">
                               <label class="form-label " for="typeEmailX-2"><h5>Địa chỉ</h5></label>
                    </div>
                    <div class="col-md-8">
