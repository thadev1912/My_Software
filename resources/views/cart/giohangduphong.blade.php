                ...
                <div class="col-lg-12">
                    <div class="cart-table">
                        <table>
                            ...
                            @foreach(Session::get('cart.id') as $user)
                            <tbody>
                                <tr>
                                    <td class="cart-pic first-row"><img src="cart/img/products/{!!$user->image!!}" style="width:80px; heigh: 80px;"alt=""></td>
                                    <td class="cart-title first-row">
                                        <h5>{!!$user->name!!}</h5>
                                    </td>
                                    <td class="p-price first-row">{!!number_format($user->price),''!!}</td>
                                    ...
                                    <td class="total-price first-row">{!!number_format($user->price*1) !!}</td>
